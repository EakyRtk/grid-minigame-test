...
const TYPE_A_PATTERNS : Array[PATTERNS] = [
	PATTERNS.SQUARE,
	PATTERNS.PAR_TOP_RIGHT, PATTERNS.PAR_TOP_LEFT, PATTERNS.PAR_BOTTOM_LEFT, PATTERNS.PAR_BOTTOM_RIGHT,
	PATTERNS.WALK_UPLEFT, PATTERNS.WALK_UPRIGHT, PATTERNS.WALK_DOWNLEFT, PATTERNS.WALK_DOWNRIGHT,
	PATTERNS.SIT_LEFT, PATTERNS.SIT_RIGHT, PATTERNS.REVERSE_SIT_LEFT, PATTERNS.REVERSE_SIT_RIGHT,
	PATTERNS.UPLINE, PATTERNS.HORIZONTAL_LINE,
	PATTERNS.T_UP, PATTERNS.T_LEFT, PATTERNS.T_RIGHT, PATTERNS.T_DOWN,
]

const TYPE_B_PATTERNS : Array[PATTERNS] = [
	PATTERNS.T_UP, PATTERNS.T_LEFT, PATTERNS.T_RIGHT, PATTERNS.T_DOWN,
	PATTERNS.BULKY_DOWN, PATTERNS.BULKY_UP, PATTERNS.BULKY_RIGHT, PATTERNS.BULKY_LEFT,
	PATTERNS.LONG_LINE_UP, PATTERNS.LONG_LINE_HORIZONTAL,
	PATTERNS.CLOSE_UPLEFT, PATTERNS.CLOSE_UPRIGHT, PATTERNS.CLOSE_BOTLEFT, PATTERNS.CLOSE_BOTRIGHT,
	PATTERNS.U_UP, PATTERNS.U_LEFT, PATTERNS.U_RIGHT, PATTERNS.U_DOWN,
	PATTERNS.STICK_UP, PATTERNS.STICK_RIGHT, PATTERNS.STICK_LEFT, PATTERNS.STICK_DOWN,
	PATTERNS.BOW_BOTRIGHT, PATTERNS.BOW_BOTLEFT, PATTERNS.BOW_UPRIGHT, PATTERNS.BOW_UPLEFT,
	PATTERNS.PLUS
]
...
func clear_piece()->void:
	...
	match add_bonus:
		...
		_:
			if score_row_amount > 1 and score_column_amount > 1: 
				add_score("+%s MULTI COMBO!", bonus_tiles.size() * score_m_row_and_column)
